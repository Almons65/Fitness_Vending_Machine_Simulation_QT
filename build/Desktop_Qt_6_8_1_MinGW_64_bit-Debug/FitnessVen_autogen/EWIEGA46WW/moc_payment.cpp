...
static constexpr auto qt_meta_stringdata_ZN7PaymentE = QtMocHelpers::stringData(
    "Payment"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN7PaymentE[] = {
...
Q_CONSTINIT const QMetaObject Payment::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN7PaymentE.offsetsAndSizes,
    qt_meta_data_ZN7PaymentE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN7PaymentE_t,
        // Q_OBJECT / Q_GADGET
...
void *Payment::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN7PaymentE.stringdata0))
