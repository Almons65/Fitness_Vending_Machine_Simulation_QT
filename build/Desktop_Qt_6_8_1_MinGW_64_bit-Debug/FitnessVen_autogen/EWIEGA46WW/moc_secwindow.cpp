...
namespace {
struct qt_meta_tag_ZN9secwindowE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN9secwindowE = QtMocHelpers::stringData(
    "secwindow",
...
Q_CONSTINIT static const uint qt_meta_data_ZN9secwindowE[] = {
...
Q_CONSTINIT const QMetaObject secwindow::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_ZN9secwindowE.offsetsAndSizes,
    qt_meta_data_ZN9secwindowE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN9secwindowE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<secwindow, std::true_type>,
...
{
    auto *_t = static_cast<secwindow *>(_o);
...
void *secwindow::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN9secwindowE.stringdata0))
